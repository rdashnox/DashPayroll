...
//                JOptionPane.showMessageDialog(null, "User Authentication Static variables:" + list.get(0).getId()
//                        + "\n " + list.get(0).getFirstLogin()
//                        + "\n " + list.get(0).getDesignation()
//                        + "\n " + list.get(0).getFirstName()
//                        + "\n " + list.get(0).getLastName()
//                        + "\n " + list.get(0).getBirthday()
//                        + "\n " + list.get(0).getEmail()
