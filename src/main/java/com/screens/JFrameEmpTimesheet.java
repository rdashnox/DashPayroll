 ...
 * @author CHAS
 */
public class JFrameEmpTimesheet extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFrameEmpTimesheet
     */
    public JFrameEmpTimesheet() {
        initComponents();
    ...
    public void loadAllDataIntoTable(List<EmpDetails> list) {
        ...
        for (EmpDetails eaLoadAllData : list) {
            ...
            v.add(eaLoadAllData.getBasicSalary());
            v.add(eaLoadAllData.getPhoneAllowance());
            v.add(eaLoadAllData.getClothingAllowance());
            v.add(eaLoadAllData.getGrossSemiMonthlyRate());
            v.add(eaLoadAllData.getHourlyRate());
    ...
    /*public void loadAllDataIntoTable_Att(List<EmpDetails> list) {
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);

        for (EmpDetails edtails : list) {
            Vector v = new Vector();
            v.add(edtails.getId());
        }
    }
    */
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1265, 843));
        setResizable(false);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Last Name", "First Name", "Basic Salary", "Phone Allowance", "Clothing Allowance", "Gross Semi-Monthly Rate", "Hourly Rate"
            }
        ) {
        ...
        jPanel1.setBackground(new java.awt.Color(223, 227, 232));
        ...
        jLabel13.setText("Total Hours Worked:");

        jLabel14.setText("Total Minutes Worked:");
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEmpTimesheet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEmpTimesheet().setVisible(true);
            }
        });
    }
